class SetupTablesFromArchive < ActiveRecord::Migration
  ...
  def up
    ...
    add_index "client_appointments", ["appointment_id"], name: "index_client_appointments_on_appointment_id", using: :btree
    ...
    add_index "sessions", ["appointment_id"], name: "index_sessions_on_appointment_id", using: :btree
